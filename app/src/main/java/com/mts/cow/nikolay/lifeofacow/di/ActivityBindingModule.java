...
public abstract class ActivityBindingModule {
    ...
    @ActivityScoped
    @ContributesAndroidInjector(modules = ListofCowModule.class)
    abstract ListofCowActivity cowlistActivity();



    @ActivityScoped
    @ContributesAndroidInjector(modules = AddCowPassportModule.class)
    abstract AddCowPassportActivity addCowPassportActivity();
